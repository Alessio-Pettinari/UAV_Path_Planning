...
def plot_planning(sol,x ,y, z, fitted_points):
    ...
    plot.plot(fitted_points[0,:],fitted_points[1,:],fitted_points[2,:], marker='^', color='g')
...
if __name__ == "__main__":
    ...
    plot_planning(sol, x, y, z, fitted_points)
